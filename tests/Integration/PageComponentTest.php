...
test('it assigns all nested layouts for a page', function () {
    $page = Viper::resolvePageComponent($this->world->rootPath . '/pages/(auth)/login.vue');
...
test('it returns the correct route name for a page', function () {
    ...
    $index = Viper::resolvePageComponent($this->world->rootPath . '/pages/index.vue');
...
test('it returns the correct laravel route for a page', function ($path, $expected) {
    $page = Viper::resolvePageComponent($this->world->rootPath . '/pages/' . $path . '.vue');
