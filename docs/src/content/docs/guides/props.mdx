...
Data is accessed in vue through `@tanstack/vue-query` [useQuery](https://tanstack.com/query/latest/docs/framework/vue/guides/queries) composables to take full advantage of their caching, refetching, loading states, etc.
